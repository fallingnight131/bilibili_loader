...
if response.status_code == 200:
    ...
    html_data = re.findall('<script>window.__playinfo__=(.*?)</script>', html_content)[0]
    ...
    # 提取视频 URL
    for video_data in json_data['data']['dash']['video']:
    ...
    # 提取音频 URL
    for audio_data in json_data['data']['dash']['audio']:
